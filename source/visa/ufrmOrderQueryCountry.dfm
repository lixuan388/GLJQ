inherited frmOrderQueryCountry: TfrmOrderQueryCountry
  Caption = #35746#21333#25253#34920'-'#22269#23478#32479#35745
  ClientHeight = 332
  ClientWidth = 770
  OnClose = FormClose
  ExplicitWidth = 786
  ...
  inherited cxTabControl1: TcxTabControl
    ...
    inherited cxTabControl2: TcxTabControl
      ...
      Properties.Tabs.Strings = (
        #35746#21333#22269#23478#32479#35745#25968#25454)
      ExplicitLeft = 0
      ExplicitTop = 0
      ExplicitWidth = 770
      ExplicitHeight = 281
  ...
  object edt_SourceName: TcxTextEdit [2]
    Left = 264
    Top = 240
    TabOrder = 6
    Width = 121
  end
  object ltv_type: TdxLookupTreeView [3]
    Left = 148
    Top = 280
    Width = 85
    Height = 18
  ...
  inherited Qry_Module: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select avg_id_aar,avg_name_aar,avg_id_act,count(0) as _count,sum' +
        '(avg_num) as _avg_num,sum(avg_amount) as _avg_amount'
